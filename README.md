...
Current packaged version: `6.2.0`
...
|---|---|---|---|
| `skillTextLines().total` / `totalBytes` (16 `SKILL.md`) | package root | **806 lines** / **55106 UTF-8 bytes** | pin in `token-accounting.test.ts` |
